...
export default function SituationAssessment() {
    ...
    return (
      <div ref={containerRef} style={widgetContainer}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div>
            <label htmlFor="sa-name" style={labelStyle}>YOUR NAME *</label>
            <input id="sa-name" type="text" value={contact.name} onChange={(e) => setContact({ ...contact, name: e.target.value })} placeholder="Full name" style={inputStyle} required aria-required="true" autoComplete="name" />
          </div>
          <div>
            <label htmlFor="sa-phone" style={labelStyle}>PHONE *</label>
            <input id="sa-phone" type="tel" value={contact.phone} onChange={(e) => setContact({ ...contact, phone: e.target.value })} placeholder="(303) 555-0000" style={inputStyle} required aria-required="true" aria-describedby="sa-phone-consent" autoComplete="tel" />
            <p id="sa-phone-consent" style={{ fontSize: "0.7rem", color: "rgba(232,226,214,0.45)", lineHeight: 1.6, margin: "8px 0 0" }}>
              By providing your phone, you consent to receive follow-up calls or text messages from Redpoint Home Solutions about your property and inquiry. Msg &amp; data rates may apply. Reply STOP to opt out. See our <a href="/privacy-policy" style={{ color: "rgba(232,226,214,0.7)", textDecoration: "underline" }}>Privacy Policy</a>.
            </p>
          </div>
          <div>
            <label htmlFor="sa-email" style={labelStyle}>EMAIL (for your results)</label>
            <input id="sa-email" type="email" value={contact.email} onChange={(e) => setContact({ ...contact, email: e.target.value })} placeholder="you@email.com" style={inputStyle} autoComplete="email" />
          </div>
          <button onClick={handleContactSubmit} style={{ ...primaryBtn, marginTop: 8 }}>
            Continue to Questions →
          </button>
        </div>
        <p style={{ fontSize: "0.72rem", color: "rgba(232,226,214,0.4)", textAlign: "center", lineHeight: 1.65, margin: "14px 0 0" }}>
          By continuing, you agree to our <a href="/privacy-policy" style={{ color: "rgba(232,226,214,0.65)", textDecoration: "underline" }}>Privacy Policy</a> and <a href="/terms" style={{ color: "rgba(232,226,214,0.65)", textDecoration: "underline" }}>Terms</a>. Your assessment is AI-generated and informational only &mdash; see <a href="/disclaimers" style={{ color: "rgba(232,226,214,0.65)", textDecoration: "underline" }}>Disclaimers</a>.
        </p>
      </div>
    );
  }
  ...
  if (step === "results" && results) {
    ...
    return (
      <div ref={containerRef} style={widgetContainer}>
        <div role="note" aria-label="AI-generated content notice" style={{ background: "rgba(196,149,106,0.06)", border: "1px solid rgba(196,149,106,0.12)", borderRadius: 8, padding: "10px 14px", marginBottom: 20, fontSize: "0.72rem", color: "rgba(232,226,214,0.6)", lineHeight: 1.65 }}>
          This assessment was generated by AI based on your answers. AI output may contain errors or outdated information. Review carefully and consult qualified professionals (attorney, accountant, real estate agent) before making material decisions about your property. See <a href="/disclaimers" style={{ color: "var(--warm)", textDecoration: "underline" }}>Disclaimers</a>.
        </div>
