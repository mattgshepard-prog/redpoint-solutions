...
export const metadata = {
  title: "Contact Redpoint Solutions | Get Help With Your Denver Property",
        ...
        <FadeIn delay={0.15}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginTop: 32 }}>
            ...
            <div style={{ background: "rgba(196,149,106,0.05)", borderRadius: 14, border: "1px solid rgba(196,149,106,0.1)", padding: "28px", textAlign: "center" }}>
              ...
              <a href="mailto:matt@redpointsolutions.ai" style={{ fontFamily: "'Playfair Display', serif", fontSize: "1rem", fontWeight: 600, color: "var(--warm)", textDecoration: "none" }}>
                matt@redpointsolutions.ai
              </a>
